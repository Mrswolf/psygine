...
def generate_ssvep_filterbank(
    passbands, stopbands, srate, order=None, rp=0.5):
    ...
    def fit(self, X, y=None, axis=-1, **kwargs):
        ...
        **kwargs : dict
        ...
        self.estimators_ = Parallel(n_jobs=self.n_jobs)(
            delayed(wrapper)(sos_coef, est, X, y, axis, kwargs) for sos_coef, est in zip(self.filterbank, self.estimators_))
        return self
    ...
    def transform(self, X, axis=-1, **kwargs):
        ...
        **kwargs : dict
        ...
        features = Parallel(n_jobs=self.n_jobs)(
            delayed(wrapper)(sos_coef, est, X, axis, kwargs) for sos_coef, est in zip(self.filterbank, self.estimators_))
        if self.concat:
